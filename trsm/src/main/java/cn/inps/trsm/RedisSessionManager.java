 ...
 * <Valve className="cn.inps.trsm.RedisSessionHandlerValve" />
   <Manager className="cn.inps.trsm.RedisSessionManager"
		host="172.16.6.100"
		port="6379"
		database="0"
  ...
  <Valve className="cn.inps.trsm.RedisSessionHandlerValve" />
  <Manager className="cn.inps.trsm.RedisSessionManager"
		hosts="172.16.6.100:7000,172.16.6.100:7001"
		maxInactiveInterval="60" />
 * 
 * 
 * 
...
public class RedisSessionManager extends ManagerBase implements Lifecycle {
  ...
  protected String hosts = "localhost:6379";
  ...
  protected String serializationStrategyClass = "cn.inps.trsm.JavaSerializer";
...
//  }
  ...
  protected JedisCluster acquireConnections() {
  ...
  private void initializeDatabaseConnection() throws LifecycleException {
    try {
      ...
      //  connectionPool = new JedisPool(this.connectionPoolConfig, getHost(), getPort(), getTimeout(), getPassword());
        jedisCluster = new JedisCluster(getClusterNodes(),jedisPoolConfig);
      }
    } catch (Exception e) {
      e.printStackTrace();
